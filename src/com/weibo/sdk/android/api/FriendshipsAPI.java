...
public class FriendshipsAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void groups_timeline(long list_id, long since_id, long max_id,
			int count, int page, int base_app, int feature,
			RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		...
		request(SERVER_URL_PRIX + "/groups/timeline.json", params,
				HTTPMETHOD_GET, listener);
	}
