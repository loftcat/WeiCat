...
public class PreferencesOfAnimationOption extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListPreferenceAnimationSpeed = (ListPreference) getPreferenceScreen()
				.findPreference(PREF_KEY_PLAY_ANIMATIONSPEED);
		mCheckPreferencePlayAnimationUsingTransparentBackground = (CheckBoxPreference) getPreferenceScreen()
				.findPreference(
						PREF_KEY_PLAY_ANIMATIONSUSINGTRANSPARENTBACKGROUND);
		mCheckPreferencePlayBackgroundAudio = (CheckBoxPreference) getPreferenceScreen()
				.findPreference(PREF_KEY_PLAY_BACKGROUNDAUDIO);
		mCheckPreferencePlayBackgroundAudioReplay = (CheckBoxPreference) getPreferenceScreen()
				.findPreference(PREF_KEY_PLAY_BACKGROUNDAUDIOREPLAY);
		mCheckPreferencePlayBackgroundAudioStop = (CheckBoxPreference) getPreferenceScreen()
				.findPreference(PREF_KEY_PLAY_BACKGROUNDAUDIOSTOP);

		mCheckPreferencePlayAnimationUsingSoundEffect = (CheckBoxPreference) getPreferenceScreen()
				.findPreference(PREF_KEY_PLAY_ANIMATIONSUSINGSOUNDEFFECT);
	...
	public void updatePreference(String key) {
		...
		if (key.equals(PREF_KEY_PLAY_ANIMATIONSPEED)) {
			...
			CharSequence[] strings = getResources().getTextArray(
					R.array.animation_speed);
			mListPreferenceAnimationSpeed.setSummary(strings[nSelectIndex]);
		} else if (key
				.equals(PREF_KEY_PLAY_ANIMATIONSUSINGTRANSPARENTBACKGROUND)) {
			if (!mCheckPreferencePlayAnimationUsingTransparentBackground
					.isChecked())
				mCheckPreferencePlayAnimationUsingTransparentBackground
						.setSummaryOff(getResources()
								.getString(
										R.string.play_animation_using_trasparent_background_off));
			else
				mCheckPreferencePlayAnimationUsingTransparentBackground
						.setSummaryOn(getResources()
								.getString(
										R.string.play_animation_using_trasparent_background_on));
		} else if (key.equals(PREF_KEY_PLAY_BACKGROUNDAUDIO)) {
			if (!mCheckPreferencePlayBackgroundAudio.isChecked())
				mCheckPreferencePlayBackgroundAudio
						.setSummaryOff(getResources().getString(
								R.string.background_audio_play_off));
			else
				mCheckPreferencePlayBackgroundAudio.setSummaryOn(getResources()
						.getString(R.string.background_audio_play_on));
		} else if (key.equals(PREF_KEY_PLAY_BACKGROUNDAUDIOREPLAY)) {
			if (!mCheckPreferencePlayBackgroundAudioReplay.isChecked())
				mCheckPreferencePlayBackgroundAudioReplay
						.setSummaryOff(getResources().getString(
								R.string.background_audio_auto_replay_off));
			else
				mCheckPreferencePlayBackgroundAudioReplay
						.setSummaryOn(getResources().getString(
								R.string.background_audio_auto_replay_on));
		} else if (key.equals(PREF_KEY_PLAY_BACKGROUNDAUDIOSTOP)) {
			if (!mCheckPreferencePlayBackgroundAudioStop.isChecked())
				mCheckPreferencePlayBackgroundAudioStop
						.setSummaryOff(getResources().getString(
								R.string.background_audio_stop_off));
			else
				mCheckPreferencePlayBackgroundAudioStop
						.setSummaryOn(getResources().getString(
								R.string.background_audio_stop_on));
		} else if (key.equals(PREF_KEY_PLAY_ANIMATIONSUSINGSOUNDEFFECT)) {
			if (!mCheckPreferencePlayAnimationUsingSoundEffect.isChecked())
				mCheckPreferencePlayAnimationUsingSoundEffect
						.setSummaryOff(getResources().getString(
								R.string.play_animation_using_sound_effect_off));
			else
				mCheckPreferencePlayAnimationUsingSoundEffect
						.setSummaryOn(getResources().getString(
								R.string.play_animation_using_sound_effect_on));
		}
	}
	...
	public static final int getPreferencePlayAnimationSpeed(Context context) {
		...
		String strPlayAnimationSpeedPref = prefs.getString(
				PREF_KEY_PLAY_ANIMATIONSPEED, "4"); // default
	...
	public static void setPreferencePlayAnimationSpeed(Context context,
			int nSpeed) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		SharedPreferences.Editor prefsEditor = prefs.edit();
		prefsEditor.putString(PREF_KEY_PLAY_ANIMATIONSPEED,
				Integer.toString(nSpeed));
		prefsEditor.commit();
	}

	// Play animation into Transparency background or not(Not yet set
	// Background)
	public static final boolean getPreferencePlayAnimationUsingTransparentBackground(
			Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		return prefs.getBoolean(
				PREF_KEY_PLAY_ANIMATIONSUSINGTRANSPARENTBACKGROUND, false); // default
	}
	...
	public static final boolean getPreferencePlayBackgroundAudioReplay(
			Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
	...
	public static final boolean getPreferencePlayBackgroundAudioStop(
			Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
	...
	public static final boolean getPreferencePlayAnimationUsingSoundEffect(
			Context context) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
