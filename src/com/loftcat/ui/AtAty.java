...
public class AtAty extends BaseActivity implements OnHeaderRefreshListener,
	...
	protected void onResume() {
		super.onResume();
		at_background.setImageResource(CacheManager.backgrounds[CacheManager.getBackGroundCache()
...
//									jsonarray, ArrayList.class, UserVO.class));
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.obj != null) {
				if (msg.what == 1) {
					friendslistAdapter = new AtFriendslistAdapter(AtAty.this,
