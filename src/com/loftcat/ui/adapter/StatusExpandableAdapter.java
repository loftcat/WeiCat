 ...
 * @Version: v1.1
 */
public class StatusExpandableAdapter extends BaseExpandableListAdapter {
	...
	public StatusExpandableAdapter(ArrayList<StatusVo> statusVos,
			Context context) {
		this.statusVos = statusVos;
	...
	public View getGroupView(final int groupPosition, boolean isExpanded,
		...
		if (statusVos.get(groupPosition).getRetweeted_status() != null) {
			...
			Log.d("RESULT", (viewHolder.retweeted_msg == null) + "msg");
